...
<head>
	...
	<link rel="stylesheet" type="text/css" href="evaluator_profile.css" />
	<title>Profile</title>
	...
	$(document).ready(function() {
		$("form").submit(function() {
			...
			if (validation.find("[name='pro_category']").val() == '') {
				alert('Enter your product category');
				return false;
			}
			...
			if (validation.find("[name='dem_value']").val() == '') {
				alert('Enter Expected value');
				return false;
			}
					...
					<div id="table">
						<table border=0>
							...
							<tr>
								...
								<td><input class="input" type=text name=street_name placeholder="" value="">
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td><input class="input" type=text name=post_office placeholder="" value="">
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td><input class="input" type=text name=taluk placeholder="" value=""></td>
							</tr>
								...
								<td>
									<div class="cancel">
										...
										function pageRedirect() {
											window.location.href = "evaluator_profile.php";
										}
										</script>
